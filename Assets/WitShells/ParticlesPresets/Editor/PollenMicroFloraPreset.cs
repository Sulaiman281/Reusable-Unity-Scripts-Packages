...
{
    public static class PollenMicroFloraPreset
    {
        public static void Configure(ParticleSystem ps)
        {
            ...
            main.gravityModifier = -0.01f; // very slight upward float
            ...
            gradient.SetKeys(
                new[]
                {
                    new GradientColorKey(new Color(0.95f, 0.95f, 0.6f), 0f),   // pale yellow (pollen)
                    new GradientColorKey(new Color(0.7f, 0.92f, 0.55f), 0.35f), // soft green (micro-flora)
                    new GradientColorKey(new Color(0.55f, 0.85f, 0.75f), 0.7f), // aqua-green
                    new GradientColorKey(new Color(0.9f, 0.9f, 0.55f), 1f)      // back to warm yellow
                },
                new[]
                {
                    new GradientAlphaKey(0f, 0f),
                    new GradientAlphaKey(0.65f, 0.1f),
