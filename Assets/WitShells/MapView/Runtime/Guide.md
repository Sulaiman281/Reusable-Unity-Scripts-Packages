...
- Copy the folder `Assets/WitShells/MapView` (and its meta files) into your target project’s `Assets/`.
- Open Unity; let it import scripts and assets.
- Ensure your project uses .NET 4.x and API Compatibility Level set to `.NET 4.x` (Project Settings → Player → Other Settings).
